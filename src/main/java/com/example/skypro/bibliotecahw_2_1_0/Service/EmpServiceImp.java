...
import com.example.skypro.bibliotecahw_2_1_0.Exception.EmployeeAlreadyAddedException;
import com.example.skypro.bibliotecahw_2_1_0.Exception.EmployeeNotFoundException;
import com.example.skypro.bibliotecahw_2_1_0.Exception.EmployeeStorageIsFullException;
import com.example.skypro.bibliotecahw_2_1_0.Exception.InvalidDataException;
...
public class EmpServiceImp implements EmpService {
    ...
    private static void correctCase(Employee employee){
        String correctedFirstName = StringUtils.capitalize(employee.getName().toLowerCase());
        employee.setName(correctedFirstName);
        String correctedSurname = StringUtils.capitalize(employee.getSurname().toLowerCase());
        employee.setSurname(correctedSurname);
    }
}
